...
const CreateCategory = () => {
    ...
    const handleCreate = async () => {
        if (!name) {
            ...
            try {
                const fetchResponse = await axios.post('http://localhost:8080/api/v1/category/create-category', {
                    name
                });
    ...
    return (
        <div>
            <ListCategories className="mt-5"/> {/* Boc */}
            <div className="flex flex-col justify-center items-center h-screen">
                ...
                <div className=" grid mt-0 grid-flow-row lg:grid-flow-col items-center align-middle lg:grid-cols-2 w-fit  bg-slate-50 p-6 round-xl shadow-md shadow-slate-400">
                    ...
                    <div className="">
                        ...
                        <input type="text" name="category" placeholder='Enter Category Here' className='w-full mt-1 p-2 outline-8'
                            onChange={
                        ...
                        <button className='mt-5 bg-blue-500 p-2 w-full text-white'
                            onClick={handleCreate}>Create New Category</button>
