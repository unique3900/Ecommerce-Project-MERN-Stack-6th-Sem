...
const Register = () => {
    ...
    const handleSubmit = async () => {
        if (!name || !email || !password || !confirmPassword || !address || !phone || !gender) {
            ...
            try {
                const fetchResponse = await axios.post('http://localhost:8080/api/v1/auth/register', {
                    name,
                    email,
                    password,
                    address,
                    ...
                    <div className="">
                        ...
                        <div className="form grid grid-flow-row  lg:grid-cols-2   gap-2  mt-5">
                            <div className="inputBox flex flex-col gap-1">
                                ...
                                <input type="text" name='name' required className='outline-black border-b-2 px-2 rounded-md shadow-sm'
                                    value={name}
                            ...
                            <div className="inputBox flex flex-col gap-1">
                                ...
                                <input type="email" name='email' required className='outline-black border-b-2 px-2 rounded-md shadow-sm'
                                    value={email}
                            ...
                            <div className="inputBox flex flex-col gap-1">
                                ...
                                <input type='location' name='address' required className='outline-black border-b-2 px-2 rounded-md shadow-sm'
                                    value={address}
                                    onChange={
                        ...
                        <button className='mt-1 bg-blue-500 p-2 w-full text-white'
